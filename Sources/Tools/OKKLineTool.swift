...
//            if index == 0 {
                // 处理第一个数据
//                model.sumOpen = model.open + (index > 0 ? klineModels[index - 1].sumOpen : 0)
//                model.sumHigh = model.high + (index > 0 ? klineModels[index - 1].sumHigh : 0)
//                model.sumLow = model.low + (index > 0 ? klineModels[index - 1].sumLow : 0)
...
//            } else {
//                
//                let previousModel = klineModels[index - 1]
//                
...
//                model.MA5 = handleMA(day: 5, model: model, index: index, models: klineModels)
//                model.MA7 = handleMA(day: 7, model: model, index: index, models: klineModels)
//                model.MA10 = handleMA(day: 10, model: model, index: index, models: klineModels)
//                model.MA12 = handleMA(day: 12, model: model, index: index, models: klineModels)
//                model.MA20 = handleMA(day: 20, model: model, index: index, models: klineModels)
//                model.MA26 = handleMA(day: 26, model: model, index: index, models: klineModels)
//                model.MA30 = handleMA(day: 30, model: model, index: index, models: klineModels)
//                model.MA60 = handleMA(day: 60, model: model, index: index, models: klineModels)
//                model.MA5_VOLUME = handleMA_VOLUME(day: 5, model: model, index: index, models: klineModels)
//                model.MA7_VOLUME = handleMA_VOLUME(day: 7, model: model, index: index, models: klineModels)
//                model.MA10_VOLUME = handleMA_VOLUME(day: 10, model: model, index: index, models: klineModels)
//                model.MA12_VOLUME = handleMA_VOLUME(day: 12, model: model, index: index, models: klineModels)
//                model.MA20_VOLUME = handleMA_VOLUME(day: 20, model: model, index: index, models: klineModels)
//                model.MA26_VOLUME = handleMA_VOLUME(day: 26, model: model, index: index, models: klineModels)
//                model.MA30_VOLUME = handleMA_VOLUME(day: 30, model: model, index: index, models: klineModels)
//                model.MA60_VOLUME = handleMA_VOLUME(day: 60, model: model, index: index, models: klineModels)
//
//                model.EMA5 = handleEMA(day: 5, model: model, index: index, previousEMA: previousModel.EMA5)
//                model.EMA7 = handleEMA(day: 7, model: model, index: index, previousEMA: previousModel.EMA7)
//                model.EMA10 = handleEMA(day: 10, model: model, index: index, previousEMA: previousModel.EMA10)
//                model.EMA12 = handleEMA(day: 12, model: model, index: index, previousEMA: previousModel.EMA12)
//                model.EMA20 = handleEMA(day: 20, model: model, index: index, previousEMA: previousModel.EMA20)
//                model.EMA26 = handleEMA(day: 26, model: model, index: index, previousEMA: previousModel.EMA26)
//                model.EMA30 = handleEMA(day: 30, model: model, index: index, previousEMA: previousModel.EMA30)
//                model.EMA60 = handleEMA(day: 60, model: model, index: index, previousEMA: previousModel.EMA60)
//                model.EMA5_VOLUME = handleEMA_VOLUME(day: 5, model: model, index: index, previousEMA_VOLUME: previousModel.EMA5_VOLUME)
//                model.EMA7_VOLUME = handleEMA_VOLUME(day: 7, model: model, index: index, previousEMA_VOLUME: previousModel.EMA7_VOLUME)
//                model.EMA10_VOLUME = handleEMA_VOLUME(day: 10, model: model, index: index, previousEMA_VOLUME: previousModel.EMA10_VOLUME)
//                model.EMA12_VOLUME = handleEMA_VOLUME(day: 12, model: model, index: index, previousEMA_VOLUME: previousModel.EMA12_VOLUME)
//                model.EMA20_VOLUME = handleEMA_VOLUME(day: 20, model: model, index: index, previousEMA_VOLUME: previousModel.EMA20_VOLUME)
//                model.EMA26_VOLUME = handleEMA_VOLUME(day: 26, model: model, index: index, previousEMA_VOLUME: previousModel.EMA26_VOLUME)
//                model.EMA30_VOLUME = handleEMA_VOLUME(day: 30, model: model, index: index, previousEMA_VOLUME: previousModel.EMA30_VOLUME)
//                model.EMA60_VOLUME = handleEMA_VOLUME(day: 60, model: model, index: index, previousEMA_VOLUME: previousModel.EMA60_VOLUME)
//                
//                model.DIF = handleDIF(model: model)
